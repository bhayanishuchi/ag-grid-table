...
@Component({
  selector: 'app-supressed-alert',
  templateUrl: './suppressed-alert.component.html',
  styleUrls: ['./suppressed-alert.component.scss']
})
export class SuppressedAlertComponent implements OnInit {
  ...
  ngOnInit() {
    this.alertService.getSuppressedAlert()
        .subscribe((res) => {
          console.log('res', res);
          this.dataSource = res;
        })
  ...
  onDblClick(val) {
    ...
    sessionStorage.setItem('page', 'suppressedalearts')
